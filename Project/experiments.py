...
model1 = models.CNN_01(32, 64, optimizer=Adam, lr=0.001, momentum=0.95)
main.train_and_evaluate(model1, 'model_01_Adam', save_folder = SAVE_PATH)

model2 = models.CNN_02(32, 64, 128, optimizer=Adam, lr=0.001, momentum=0.95)
main.train_and_evaluate(model2, 'model_02_Adam', save_folder = SAVE_PATH)

model3 = models.CNN_03(32, 64, optimizer=Adam, lr=0.001, momentum=0.95)
main.train_and_evaluate(model3, 'model_03_Adam', save_folder = SAVE_PATH)

model4 = models.CNN_04(32, 64, 128, optimizer=Adam, lr=0.001, momentum=0.95)
main.train_and_evaluate(model4, 'model_04_Adam', save_folder = SAVE_PATH)

FCN = models.FCN_05(32, 64, 128, optimizer=Adam, lr=0.001, momentum=0.95)
main.train_and_evaluate(FCN, 'model_05_Adam', save_folder = SAVE_PATH)

model6 = models.CNN_06(32, 64, 128, 256, optimizer=Adam, lr=0.001, momentum=0.95)
